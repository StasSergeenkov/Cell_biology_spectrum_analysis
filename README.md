...
# Анализ сходства УФ-ВИС спектров: описание алгоритмов
...
### 5.2 Сравнение используемого подхода с альтернативными метриками
...
Код, а также часть алгоритма обработки данных созданы с применением DeepSeek-V3.2.
